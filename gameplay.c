...
/*   Updated: 2023/06/12 12:12:22 by fruiz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((pushedkey.key == MLX_KEY_W || pushedkey.key == MLX_KEY_UP) && pushedkey.action == MLX_PRESS)
		pushing_w(game);
	else if ((pushedkey.key == MLX_KEY_S || pushedkey.key == MLX_KEY_DOWN) && pushedkey.action == MLX_PRESS)
		pushing_s(game);
	else if ((pushedkey.key == MLX_KEY_D || pushedkey.key == MLX_KEY_RIGHT) && pushedkey.action == MLX_PRESS)
		pushing_d(game);
	else if ((pushedkey.key == MLX_KEY_A || pushedkey.key == MLX_KEY_LEFT) && pushedkey.action == MLX_PRESS)
		pushing_a(game);
